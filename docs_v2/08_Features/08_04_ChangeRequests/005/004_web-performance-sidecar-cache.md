<!-- docs_v2/08_Features/08_04_ChangeRequests/005/004_web-performance-sidecar-cache.md -->
...
- Sidecar cache semantics (when to reuse vs. refresh, and how to fall back to OpenAI) follow the canonical definition in `docs_v2/08_Features/08_04_ChangeRequests/001/001_sidecars-as-ai-cache.md`.
