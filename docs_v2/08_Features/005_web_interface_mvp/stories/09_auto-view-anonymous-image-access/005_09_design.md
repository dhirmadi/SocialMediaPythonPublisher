<!-- docs_v2/08_Features/08_04_ChangeRequests/005/008_design.md -->
...
**Author:** Evert  
**Linked Change Request:** docs_v2/08_Features/08_04_ChangeRequests/005/008_auto-view-anonymous-image-access.md  
...
- **Task 6:** Update relevant documentation under `docs_v2/08_Features/08_04_ChangeRequests/005` and, if needed, configuration docs to mention `AUTO_VIEW` semantics and defaults.
