<!-- docs_v2/08_Epics/012_central-config-i18n-text.md -->
...
- **Feature Request:** `docs_v2/08_Epics/08_01_Feature_Request/012_central-config-i18n-text.md`
- **Feature Design:** `docs_v2/08_Epics/08_02_Feature_Design/012_central-config-i18n-text_design.md`
- **Plan:** `docs_v2/08_Epics/08_03_Feature_plan/012_central-config-i18n-text_plan.yaml`
- **Shipped Summary (this file):** `docs_v2/08_Epics/012_central-config-i18n-text.md`
- **i18n Activation Guide:** `docs_v2/08_Epics/004_deployment_ops_modernization/012_i18n_activation_summary.md`
- **Documentation Update Summary:** `docs_v2/08_Epics/012_DOCUMENTATION_UPDATE_SUMMARY.md`
