...
class TestGetFileMetadataErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_file_metadata_raises_storage_error(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestListImagesErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_list_images_raises_storage_error(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestListImagesWithHashesErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_list_images_with_hashes_raises_storage_error(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestDownloadImageErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_download_image_raises_storage_error(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestGetTemporaryLinkErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_temporary_link_raises_storage_error(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestEnsureFolderExistsErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_ensure_folder_exists_creates_folder(self, storage_with_mock_client: DropboxStorage) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_folder_exists_ignores_conflict_error(self, storage_with_mock_client: DropboxStorage) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_folder_exists_raises_on_other_errors(self, storage_with_mock_client: DropboxStorage) -> None:
...
class TestDownloadSidecarIfExistsErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_download_sidecar_returns_none_on_not_found(self, storage_with_mock_client: DropboxStorage) -> None:
